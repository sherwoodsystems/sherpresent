...
//! [`BridgeState`] and returns JSON. The error type is always a plain string
//! body with a 500 status.
...
// Device test
// =============================================================================
// TODO: re-add test_device once the async OscSender future satisfies
// axum's Handler `Send` bound. The Tauri `send_test_osc` command already
// covers this functionality for the local UI.
// =============================================================================
...
<body>
  ...
  <div class="card">
    <p>The bridge is running. Configure it from the Tauri app running on the bridge device itself.</p>
    ...
    <ul>
      ...
      <li><span class="mono">POST /devices/{slot}/test/{next|prev}</span></li>
    </ul>
  </div>
</body>
</html>
